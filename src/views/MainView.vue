<template>
  ...
  <div
    class="flex flex-col overflow-y-auto w-screen lg:w-2/3 h-screen px-10 pt-5 pb-64 xl:pb-5 mx-auto bg-custom-bunker"
  >
    ...
    <div class="flex flex-col lg:flex-row mt-14 w-full h-auto lg:h-64">
      <div class="w-full h-64 lg:h-full lg:w-5/12 px-5">
        ...
        <div class="mt-2 w-full h-full rounded-3xl overflow-hidden">
          <location-picker-map :mapCenter="currentLocation" />
        </div>
      </div>
      <div
